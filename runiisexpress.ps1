...
$appPPath = (join-path $executingPath "SignalrSample")
...
## iisexpress /path:"C:\Users\stefan\Documents\Visual Studio 2013\Projects\SignalrSample\SignalrSample\" /port:9090